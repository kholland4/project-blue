...
<body>
  <div id="container">
    ...
    <form id="f1" action="register.php" method="POST" id="f1">
      ...
      <input placeholder="First name" type="text" name="firstname" minlength="1" maxlength="100" pattern="^[A-Za-z\-]+$" title="Letters and hyphens only." required><br>
      <input placeholder="Last name" type="text" name="lastname" minlength="1" maxlength="100" pattern="^[A-Za-z\-]+$" title="Letters and hyphens only." required><br>
